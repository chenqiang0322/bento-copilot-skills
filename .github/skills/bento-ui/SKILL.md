---
name: bento-ui
description: Modular grid layout with card-like blocks, clear hierarchy, soft spacing, and subtle visual contrast for organized, scannable interfaces. Use when asked to build bento box / dashboard / card-grid UI, web layouts, or component libraries with a bento aesthetic.
license: MIT
metadata:
  author: typeui.sh
